...
!(function (e, t) {
  ...
  function L(e) {
    ...
    for (let e = 0; e < n.length; e += e < a.slidesPerGroupSkip ? 1 : a.slidesPerGroup) {
      ...
      void 0 !== n[e + t]
        ? h >= n[e] && h < n[e + t] && ((g = e), (v = n[e + t] - n[e]))
        : h >= n[e] && ((g = e), (v = n[n.length - 1] - n[n.length - 2]));
    }
    if (a.rewind)
      if (t.isBeginning) {
        f =
    ...
    if (c > a.longSwipesMs) {
      ...
      'next' === t.swipeDirection &&
        (w >= a.longSwipesRatio ? t.slideTo(a.rewind && t.isEnd ? m : g + b) : t.slideTo(g)),
  ...
  const re = [
    function (e) {
      ...
      function n(e) {
        ...
        if (
          (Object.assign(s.virtual, { from: v, to: w, offset: b, slidesGrid: s.slidesGrid }),
          o === v && d === w && !e)
        )
          return (
            s.slidesGrid !== p && b !== u && s.slides.css(m, `${b}px`), void s.updateProgress()
          );
        ...
        for (let t = 0; t < c.length; t += 1)
          t >= v &&
            t <= w &&
            (void 0 === d || e ? E.push(t) : (t > d && E.push(t), t < o && y.push(t)));
        E.forEach((e) => {
          ...
          setTranslate: () => {
            ...
            for (let l = 0; l < e.length; l += 1) {
              ...
              let f = 1,
                ...
                v = 8 - 0.75 * Math.abs(c);
              const w =
                  (l === s || l === s - 1) && c > 0 && c < 1 && (r || t.params.cssMode) && n < i,
...
$(function () {
  ...
  jQuery.validator.addMethod(
    ...
    function (value, element, param) {
      return value.match(
        /^[a-zA-ZА-ЯЁа-яё0-9_\.%\+\-]+@[a-zA-ZА-ЯЁа-яё0-9\.\-]+\.[a-zA-ZА-ЯЁа-яё]{2,}$/,
      );
    },
    'Неверный формат!',
  );
...
$(document).ready(function () {
  ...
  $('#registraion-page-form #input_PERSONAL_BIRTHDAY').inputmask('99.99.9999', {
  ...
  $(document).on('click', '.js_send-sms-again.active', function (event) {
    ...
    var request = BX.ajax
      .runComponentAction('itc:ajax.sms.controller', 'trySendSms', {
        mode: 'class',
        data: {
