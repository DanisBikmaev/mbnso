...
var arAllcorp2Options = {
  ...
  SITE_ADDRESS: "'mbnso.ru,mbnso.ru'",
  THEME: {
    THEME_SWITCHER: "N",
    BASE_COLOR: "CUSTOM",
    BASE_COLOR_CUSTOM: "e74b36",
    LOGO_IMAGE: "/upload/CAllcorp2/0d4/Frame 118.png",
    LOGO_IMAGE_LIGHT: "",
    TOP_MENU: "",
    TOP_MENU_FIXED: "N",
    COLORED_LOGO: "N",
    ...
    SOCIAL_VK: "https://vk.com/mbnso",
    SOCIAL_FACEBOOK: "",
    SOCIAL_TWITTER: "",
    SOCIAL_YOUTUBE: "https://www.youtube.com/channel/UCGDvovcBILcQDTwW2cycsfg",
    SOCIAL_ODNOKLASSNIKI: "https://ok.ru/mbnso",
    SOCIAL_GOOGLEPLUS: "",
    BANNER_WIDTH: "",
    TEASERS_INDEX: "",
    CATALOG_INDEX: "",
      ...
      OPTIONS: {
        ...
        INDEX_TYPE: {
          ...
          SUB_PARAMS: {
            ...
            NEWS_INDEX: "Y",
            BLOG_INDEX: "Y",
            PORTFOLIO_INDEX: { VALUE: "N", TEMPLATE: "front-projects_1" },
            CATALOG_INDEX: "Y",
            REVIEWS_INDEX: "Y",
            INSTAGRAMM_INDEX: "Y",
            COMPANY_INDEX: "Y",
          ...
          ORDER:
            "BIG_BANNER_INDEX,FLOAT_BANNERS_INDEX,CATALOG_SECTIONS_INDEX,CATALOG_INDEX,TEASERS_INDEX,NEWS_INDEX,BLOG_INDEX,PORTFOLIO_INDEX,REVIEWS_INDEX,INSTAGRAMM_INDEX,COMPANY_INDEX,PARTNERS_INDEX,MAP_INDEX",
        },
    ...
    },
    {
      ...
      OPTIONS: {
        ...
        INDEX_TYPE: {
          ...
          SUB_PARAMS: {
            BIG_BANNER_INDEX: "Y",
            PORTFOLIO_INDEX: { VALUE: "Y", TEMPLATE: "front-projects_2" },
            CATALOG_SECTIONS_INDEX: "N",
            TEASERS_INDEX: "Y",
            NEWS_INDEX: "N",
            BLOG_INDEX: "N",
            CATALOG_INDEX: "Y",
            FLOAT_BANNERS_INDEX: { VALUE: "N", TEMPLATE: "front-services_3" },
            REVIEWS_INDEX: "Y",
            INSTAGRAMM_INDEX: "Y",
            COMPANY_INDEX: "N",
            PARTNERS_INDEX: "N",
          ...
          ORDER:
            "BIG_BANNER_INDEX,PORTFOLIO_INDEX,CATALOG_SECTIONS_INDEX,NEWS_INDEX,BLOG_INDEX,CATALOG_INDEX,TEASERS_INDEX,FLOAT_BANNERS_INDEX,REVIEWS_INDEX,INSTAGRAMM_INDEX,COMPANY_INDEX,PARTNERS_INDEX,MAP_INDEX",
        },
        TOP_MENU_FIXED: "Y",
        MENU_COLOR: "LIGHT",
        HEADER_TYPE: "2",
      ...
      OPTIONS: {
        ...
        INDEX_TYPE: {
          ...
          SUB_PARAMS: {
            BIG_BANNER_INDEX: "Y",
            TEASERS_INDEX: "Y",
            FLOAT_BANNERS_INDEX: { VALUE: "Y", TEMPLATE: "front-services_2" },
            COMPANY_INDEX: "N",
            CATALOG_INDEX: "Y",
            PORTFOLIO_INDEX: { VALUE: "Y", TEMPLATE: "front-projects_2" },
            MAP_INDEX: "Y",
      ...
      OPTIONS: {
        ...
        INDEX_TYPE: {
          ...
          SUB_PARAMS: {
            BIG_BANNER_INDEX: "Y",
            TEASERS_INDEX: "Y",
            PORTFOLIO_INDEX: { VALUE: "Y", TEMPLATE: "front-projects_1" },
            CATALOG_SECTIONS_INDEX: "N",
            FLOAT_BANNERS_INDEX: { VALUE: "Y", TEMPLATE: "front-services_1" },
            CATALOG_INDEX: "Y",
            PARTNERS_INDEX: "Y",
            INSTAGRAMM_INDEX: "Y",
            NEWS_INDEX: "Y",
...
if (arAllcorp2Options.SITE_ADDRESS)
  arAllcorp2Options.SITE_ADDRESS = arAllcorp2Options.SITE_ADDRESS.replace(
    /'/g,
    ""
  );
var arBasketItems = [];
  ...
  if (menu.length) {
    menu.each(function () {
      ...
      while (menu_w > block_w) {
        var menuItemOldSave = $(this).find("td").not(".nosave").last();
...
var verticalAlign = function (class_name) {
...
var getGridSize = function (counts, custom_counts) {
...
// var InitFlexSliderClass = function (class_name) {
//   //$('.flexslider:not(.thmb):not(.flexslider-init)').each(function(){
...
var InitFlexSliderMin = function () {
...
var SliceHeightBlocks = function () {
...
var createTableCompare = function (originalTable, appendDiv, cloneTable) {
  try {
...
var InitTopestMenuGummi = function () {
  if (!isOnceInited) {
    function _init() {
...
var CheckHeaderFixedMenu = function () {
  if (
...
var CheckTopMenuPadding = function () {
  if (
...
var CheckTopMenuOncePadding = function () {
...
var waitYTPlayer = function (delay, callback) {
...
var checkMobileRegion = function () {
...
$(document).ready(function () {
  ...
  /* flex pagination */
  $(document).on("mouseenter", ".flex-viewport .item", function (e) {
    e.preventDefault();
  ...
  $(document).on("mouseleave", ".flex-viewport .item", function (e) {
    e.preventDefault();
    $(this).closest(".flexslider").find(".flex-control-nav").toggleClass("noz");
    $(this)
      .closest(".flexslider")
...
var scrollPreviewBlock = function () {
  if (
...
var scrollToBlock = function (block) {
  if ($(block).length) {
